		...
		<>
			...
			>
				...
				<form onSubmit={handleSubmit}>
					...
					<section className='updateToMpLabel_Input'>
						<label id='updateToMPLabel'>Meal Type:</label>
						<br />
						<select
							id='updateToMpInput'
							value={mealType}
					...
					<section className='updateToMPContainer'>
						<button id='updateToMPButton' type='submit'>
							Update
						</button>
					</section>
				</form>
				<button id='removeMPButton' onClick={handleDelete}>
					Remove from Meal Planner
				</button>
				<section className='cancelContainer'>
					<button id='cancelMPButton' onClick={onClose}>
						Cancel
					</button>
				</section>
			</section>
