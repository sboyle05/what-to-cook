...
Revision ID: a3352cb448c7
Revises:
Create Date: 2023-09-21 13:32:26.757194
...
def upgrade():
    ...
    op.create_table('shoppinglist_ingredients',
    sa.Column('shoppinglist_id', sa.Integer(), nullable=False),
    sa.Column('ingredient_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['ingredient_id'], ['ingredients.id'], ),
    sa.ForeignKeyConstraint(['shoppinglist_id'], ['shopping_lists.id'], ),
    sa.PrimaryKeyConstraint('shoppinglist_id', 'ingredient_id')
    )
    op.create_table('shoppinglist_measured_ingredients',
    sa.Column('shoppinglist_id', sa.Integer(), nullable=False),
    sa.Column('measured_ingredient_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['measured_ingredient_id'], ['measured_ingredients.id'], ),
    sa.ForeignKeyConstraint(['shoppinglist_id'], ['shopping_lists.id'], ),
    sa.PrimaryKeyConstraint('shoppinglist_id', 'measured_ingredient_id')
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('shoppinglist_measured_ingredients')
    op.drop_table('shoppinglist_ingredients')
